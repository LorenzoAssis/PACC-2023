...
//turtle.debug = true;
turtle.scale =0.18;
turtle.setCollider("rectangle",0,-90,1000,700)
...
obstacleBottom.y = Math.round(random(windowHeight-130,600));


obstacleBottom.scale = 0.1;
obstacleBottom.velocityX = -14;
...
switch(rand) {
  case 1: obstacleBottom.addImage(obsShark);
          obstacleBottom.scale=0.17
          obstacleBottom.setCollider("rectangle",0,0,3100,900)
          break;
